...
<body class="sb-nav-fixed">
    <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
        <!-- Navbar Brand-->
        <a class="navbar-brand ps-3" href="index.html">A fondo con Andreina</a>
        <!-- Sidebar Toggle-->
            ...
            <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                <div class="sb-sidenav-menu">
                    <div class="nav">
                        ...
                        <a class="nav-link" href="<?php echo ADMIN_URL;?>entradas">
                        ...
                        <div class="sb-nav-link-icon"><i class='bx bx-chat icon'></i></div>
                            <span class="text nav-text">Comentarios</span>
                        </a>
                        <a class="nav-link" href="<?php echo ADMIN_URL;?>autor">
                        <div class="sb-nav-link-icon"><i class='bx bx-user-circle icon'></i></div>
