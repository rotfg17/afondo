...
$sql = $con->prepare("SELECT id, titulo, subtitulo, contenido FROM articulo WHERE activo = 1 AND id_categoria = 6 ORDER BY fecha ");
$sql->execute();
...
<head>
    ...
    <title>A fondo con Andreina - Economía</title>
</head>
<body>
